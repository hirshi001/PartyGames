...
public class PluginApplication extends LwjglApplication {

    private PluginManager manager;

    public PluginApplication(PartyGames listener, PluginManager manager, LwjglApplicationConfiguration config) {
    ...
    protected ApplicationLogger createApplicationLogger(){
        BetterApplicationLogger logger = new BetterApplicationLogger("name", ConsoleColors.GREEN, ConsoleColors.RED, System.out, System.err,
