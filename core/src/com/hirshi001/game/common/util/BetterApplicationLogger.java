...
public class BetterApplicationLogger extends Logger implements ApplicationLogger {
    ...
    @SafeVarargs
    public BetterApplicationLogger(String name, String tagColor, String warnTagColor, OutputStream out, PrintStream err, Supplier<String>... stringSuppliers) {
        super(name, out, err, stringSuppliers);
